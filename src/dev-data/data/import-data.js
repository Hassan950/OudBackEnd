...
const albums2 = JSON.parse(fs.readFileSync(`${__dirname}/albums.json`, 'utf-8'));

const tracks2 = JSON.parse(fs.readFileSync(`${__dirname}/tracks.json`), 'utf-8');

// delete this later
const albums = JSON.parse(fs.readFileSync(`${__dirname}/tarek_seeds/albums.json`, 'utf-8'));

const tracks = JSON.parse(fs.readFileSync(`${__dirname}/tarek_seeds/tracks.json`), 'utf-8');
